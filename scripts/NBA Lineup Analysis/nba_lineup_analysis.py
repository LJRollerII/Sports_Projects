...
# Function to get the lineups given a team id for the 2022-23 season
...
# Loop to get all league lineups
...
for i in team_dict:
    ...
    team_lineup['team id'] = team_id_i # Adding team id column
...
league_lineup = league_lineup.to_csv('NBALineup2022_2023.csv')